...
class DataGenerator:
    ...
    # Code changed according to SUNRGB Dataset which has csv format as [imagePath objid xmin ymin xmax ymax]
    def parse_csv(self,
                  images_dir,
                  labels_filename,
                  input_format,
                ...
                if i == len(data)-1: # If this is the last line of the CSV file
                    if random_sample: # In case we're not using the full dataset, but a random sample of it.
                        ...
                        if p >= (1-random_sample):
                            ...
                            self.filenames.append(self.images_dir + current_file)
